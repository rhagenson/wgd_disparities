...
mutagen.proportions.nsclc %>%
  ...
  fmt_number(
    columns = c(BLACK.mean, WHITE.mean, statistic),
    decimals = 2
  ) %>%
  opt_stylize(style = 1, color = 'gray') %>%
  opt_table_font(font = 'Arial')
...
forest_model(
  ...
  labs(title = "Cox Proportional Hazards Analysis of WGD Events and Patient Survival") +
  theme(
...
ggsave("Figure S10.png", width = 11, height = 8.5, units = "in")
```
